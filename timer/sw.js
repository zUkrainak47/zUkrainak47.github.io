const APP_CACHE_NAME = 'ukratimer-app-v2026040577';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040577';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040577',
    './css/fonts.css?v=2026040577',
    './css/variables.css?v=2026040577',
    './css/base.css?v=2026040577',
    './css/layout.css?v=2026040577',
    './css/scramble.css?v=2026040577',
    './css/timer.css?v=2026040577',
    './css/stats.css?v=2026040577',
    './css/cube.css?v=2026040577',
    './css/graph.css?v=2026040577',
    './css/modal.css?v=2026040577',
    './css/settings.css?v=2026040577',
    './js/app.js?v=2026040577',
    './js/timer.js?v=2026040577',
    './js/scramble.js?v=2026040577',
    './js/session.js?v=2026040577',
    './js/settings.js?v=2026040577',
    './js/stats.js?v=2026040577',
    './js/modal.js?v=2026040577',
    './js/cube-display.js?v=2026040577',
    './js/graph.js?v=2026040577',
    './js/utils.js?v=2026040577',
    './js/storage.js?v=2026040577',
    './js/db.js?v=2026040577',
    './js/distribution.js?v=2026040577',
    './js/google-drive-sync.js?v=2026040577',
