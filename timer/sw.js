const APP_CACHE_NAME = 'ukratimer-app-v2026040568';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040568';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040568',
    './css/fonts.css?v=2026040568',
    './css/variables.css?v=2026040568',
    './css/base.css?v=2026040568',
    './css/layout.css?v=2026040568',
    './css/scramble.css?v=2026040568',
    './css/timer.css?v=2026040568',
    './css/stats.css?v=2026040568',
    './css/cube.css?v=2026040568',
    './css/graph.css?v=2026040568',
    './css/modal.css?v=2026040568',
    './css/settings.css?v=2026040568',
    './js/app.js?v=2026040568',
    './js/timer.js?v=2026040568',
    './js/scramble.js?v=2026040568',
    './js/session.js?v=2026040568',
    './js/settings.js?v=2026040568',
    './js/stats.js?v=2026040568',
    './js/modal.js?v=2026040568',
    './js/cube-display.js?v=2026040568',
    './js/graph.js?v=2026040568',
    './js/utils.js?v=2026040568',
    './js/storage.js?v=2026040568',
    './js/db.js?v=2026040568',
    './js/distribution.js?v=2026040568',
    './js/google-drive-sync.js?v=2026040568',
