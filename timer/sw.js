const APP_CACHE_NAME = 'ukratimer-app-v2026040703';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040703';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040703',
    './css/fonts.css?v=2026040703',
    './css/variables.css?v=2026040703',
    './css/base.css?v=2026040703',
    './css/layout.css?v=2026040703',
    './css/scramble.css?v=2026040703',
    './css/timer.css?v=2026040703',
    './css/stats.css?v=2026040703',
    './css/cube.css?v=2026040703',
    './css/graph.css?v=2026040703',
    './css/modal.css?v=2026040703',
    './css/settings.css?v=2026040703',
    './js/app.js?v=2026040703',
    './js/timer.js?v=2026040703',
    './js/scramble.js?v=2026040703',
    './js/subset-scramblers.js?v=2026040703',
    './js/session.js?v=2026040703',
    './js/settings.js?v=2026040703',
    './js/stats.js?v=2026040703',
    './js/modal.js?v=2026040703',
    './js/cube-display.js?v=2026040703',
    './js/graph.js?v=2026040703',
    './js/utils.js?v=2026040703',
    './js/storage.js?v=2026040703',
    './js/db.js?v=2026040703',
    './js/distribution.js?v=2026040703',
    './js/google-drive-sync.js?v=2026040703',
