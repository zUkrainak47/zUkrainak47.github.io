const APP_CACHE_NAME = 'ukratimer-app-v2026040569';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040569';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040569',
    './css/fonts.css?v=2026040569',
    './css/variables.css?v=2026040569',
    './css/base.css?v=2026040569',
    './css/layout.css?v=2026040569',
    './css/scramble.css?v=2026040569',
    './css/timer.css?v=2026040569',
    './css/stats.css?v=2026040569',
    './css/cube.css?v=2026040569',
    './css/graph.css?v=2026040569',
    './css/modal.css?v=2026040569',
    './css/settings.css?v=2026040569',
    './js/app.js?v=2026040569',
    './js/timer.js?v=2026040569',
    './js/scramble.js?v=2026040569',
    './js/session.js?v=2026040569',
    './js/settings.js?v=2026040569',
    './js/stats.js?v=2026040569',
    './js/modal.js?v=2026040569',
    './js/cube-display.js?v=2026040569',
    './js/graph.js?v=2026040569',
    './js/utils.js?v=2026040569',
    './js/storage.js?v=2026040569',
    './js/db.js?v=2026040569',
    './js/distribution.js?v=2026040569',
    './js/google-drive-sync.js?v=2026040569',
