const APP_CACHE_NAME = 'ukratimer-app-v2026040906';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040906';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040906',
    './css/fonts.css?v=2026040906',
    './css/variables.css?v=2026040906',
    './css/base.css?v=2026040906',
    './css/layout.css?v=2026040906',
    './css/scramble.css?v=2026040906',
    './css/timer.css?v=2026040906',
    './css/stats.css?v=2026040906',
    './css/cube.css?v=2026040906',
    './css/graph.css?v=2026040906',
    './css/modal.css?v=2026040906',
    './css/settings.css?v=2026040906',
    './js/app.js?v=2026040906',
    './js/timer.js?v=2026040906',
    './js/scramble.js?v=2026040906',
    './js/subset-scramblers.js?v=2026040906',
    './js/session.js?v=2026040906',
    './js/settings.js?v=2026040906',
    './js/stats.js?v=2026040906',
    './js/modal.js?v=2026040906',
    './js/cube-display.js?v=2026040906',
    './js/graph.js?v=2026040906',
    './js/utils.js?v=2026040906',
    './js/storage.js?v=2026040906',
    './js/db.js?v=2026040906',
    './js/distribution.js?v=2026040906',
    './js/google-drive-sync.js?v=2026040906',
