const APP_CACHE_NAME = 'ukratimer-app-v2026040905';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040905';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040905',
    './css/fonts.css?v=2026040905',
    './css/variables.css?v=2026040905',
    './css/base.css?v=2026040905',
    './css/layout.css?v=2026040905',
    './css/scramble.css?v=2026040905',
    './css/timer.css?v=2026040905',
    './css/stats.css?v=2026040905',
    './css/cube.css?v=2026040905',
    './css/graph.css?v=2026040905',
    './css/modal.css?v=2026040905',
    './css/settings.css?v=2026040905',
    './js/app.js?v=2026040905',
    './js/timer.js?v=2026040905',
    './js/scramble.js?v=2026040905',
    './js/subset-scramblers.js?v=2026040905',
    './js/session.js?v=2026040905',
    './js/settings.js?v=2026040905',
    './js/stats.js?v=2026040905',
    './js/modal.js?v=2026040905',
    './js/cube-display.js?v=2026040905',
    './js/graph.js?v=2026040905',
    './js/utils.js?v=2026040905',
    './js/storage.js?v=2026040905',
    './js/db.js?v=2026040905',
    './js/distribution.js?v=2026040905',
    './js/google-drive-sync.js?v=2026040905',
