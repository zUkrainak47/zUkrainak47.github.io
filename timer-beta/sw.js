const APP_CACHE_NAME = 'ukratimer-app-v202604047';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604047';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604047',
    './css/fonts.css?v=202604047',
    './css/variables.css?v=202604047',
    './css/base.css?v=202604047',
    './css/layout.css?v=202604047',
    './css/scramble.css?v=202604047',
    './css/timer.css?v=202604047',
    './css/stats.css?v=202604047',
    './css/cube.css?v=202604047',
    './css/graph.css?v=202604047',
    './css/modal.css?v=202604047',
    './css/settings.css?v=202604047',
    './js/app.js?v=202604047',
    './js/timer.js?v=202604047',
    './js/scramble.js?v=202604047',
    './js/session.js?v=202604047',
    './js/settings.js?v=202604047',
    './js/stats.js?v=202604047',
    './js/modal.js?v=202604047',
    './js/cube-display.js?v=202604047',
    './js/graph.js?v=202604047',
    './js/utils.js?v=202604047',
    './js/storage.js?v=202604047',
    './js/db.js?v=202604047',
    './js/distribution.js?v=202604047',
    './js/google-drive-sync.js?v=202604047',
