const APP_CACHE_NAME = 'ukratimer-app-v202604056';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604056';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604056',
    './css/fonts.css?v=202604056',
    './css/variables.css?v=202604056',
    './css/base.css?v=202604056',
    './css/layout.css?v=202604056',
    './css/scramble.css?v=202604056',
    './css/timer.css?v=202604056',
    './css/stats.css?v=202604056',
    './css/cube.css?v=202604056',
    './css/graph.css?v=202604056',
    './css/modal.css?v=202604056',
    './css/settings.css?v=202604056',
    './js/app.js?v=202604056',
    './js/timer.js?v=202604056',
    './js/scramble.js?v=202604056',
    './js/session.js?v=202604056',
    './js/settings.js?v=202604056',
    './js/stats.js?v=202604056',
    './js/modal.js?v=202604056',
    './js/cube-display.js?v=202604056',
    './js/graph.js?v=202604056',
    './js/utils.js?v=202604056',
    './js/storage.js?v=202604056',
    './js/db.js?v=202604056',
    './js/distribution.js?v=202604056',
    './js/google-drive-sync.js?v=202604056',
