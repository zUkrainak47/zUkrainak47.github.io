const APP_CACHE_NAME = 'ukratimer-app-v2026041604';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041604';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041604',
    './css/fonts.css?v=2026041604',
    './css/variables.css?v=2026041604',
    './css/base.css?v=2026041604',
    './css/layout.css?v=2026041604',
    './css/scramble.css?v=2026041604',
    './css/timer.css?v=2026041604',
    './css/stats.css?v=2026041604',
    './css/cube.css?v=2026041604',
    './css/graph.css?v=2026041604',
    './css/modal.css?v=2026041604',
    './css/settings.css?v=2026041604',
    './js/app.js?v=2026041604',
    './js/timer.js?v=2026041604',
    './js/scramble.js?v=2026041604',
    './js/subset-scramblers.js?v=2026041604',
    './js/session.js?v=2026041604',
    './js/settings.js?v=2026041604',
    './js/stats.js?v=2026041604',
    './js/modal.js?v=2026041604',
    './js/cube-display.js?v=2026041604',
    './js/graph.js?v=2026041604',
    './js/utils.js?v=2026041604',
    './js/storage.js?v=2026041604',
    './js/db.js?v=2026041604',
    './js/distribution.js?v=2026041604',
    './js/google-drive-sync.js?v=2026041604',
