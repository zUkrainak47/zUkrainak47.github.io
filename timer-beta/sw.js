const APP_CACHE_NAME = 'ukratimer-app-v2026041605';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041605';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041605',
    './css/fonts.css?v=2026041605',
    './css/variables.css?v=2026041605',
    './css/base.css?v=2026041605',
    './css/layout.css?v=2026041605',
    './css/scramble.css?v=2026041605',
    './css/timer.css?v=2026041605',
    './css/stats.css?v=2026041605',
    './css/cube.css?v=2026041605',
    './css/graph.css?v=2026041605',
    './css/modal.css?v=2026041605',
    './css/settings.css?v=2026041605',
    './js/app.js?v=2026041605',
    './js/timer.js?v=2026041605',
    './js/scramble.js?v=2026041605',
    './js/subset-scramblers.js?v=2026041605',
    './js/session.js?v=2026041605',
    './js/settings.js?v=2026041605',
    './js/stats.js?v=2026041605',
    './js/modal.js?v=2026041605',
    './js/cube-display.js?v=2026041605',
    './js/graph.js?v=2026041605',
    './js/utils.js?v=2026041605',
    './js/storage.js?v=2026041605',
    './js/db.js?v=2026041605',
    './js/distribution.js?v=2026041605',
    './js/google-drive-sync.js?v=2026041605',
