const APP_CACHE_NAME = 'ukratimer-app-v2026040907';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040907';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040907',
    './css/fonts.css?v=2026040907',
    './css/variables.css?v=2026040907',
    './css/base.css?v=2026040907',
    './css/layout.css?v=2026040907',
    './css/scramble.css?v=2026040907',
    './css/timer.css?v=2026040907',
    './css/stats.css?v=2026040907',
    './css/cube.css?v=2026040907',
    './css/graph.css?v=2026040907',
    './css/modal.css?v=2026040907',
    './css/settings.css?v=2026040907',
    './js/app.js?v=2026040907',
    './js/timer.js?v=2026040907',
    './js/scramble.js?v=2026040907',
    './js/subset-scramblers.js?v=2026040907',
    './js/session.js?v=2026040907',
    './js/settings.js?v=2026040907',
    './js/stats.js?v=2026040907',
    './js/modal.js?v=2026040907',
    './js/cube-display.js?v=2026040907',
    './js/graph.js?v=2026040907',
    './js/utils.js?v=2026040907',
    './js/storage.js?v=2026040907',
    './js/db.js?v=2026040907',
    './js/distribution.js?v=2026040907',
    './js/google-drive-sync.js?v=2026040907',
