const APP_CACHE_NAME = 'ukratimer-app-v2026041603';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041603';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041603',
    './css/fonts.css?v=2026041603',
    './css/variables.css?v=2026041603',
    './css/base.css?v=2026041603',
    './css/layout.css?v=2026041603',
    './css/scramble.css?v=2026041603',
    './css/timer.css?v=2026041603',
    './css/stats.css?v=2026041603',
    './css/cube.css?v=2026041603',
    './css/graph.css?v=2026041603',
    './css/modal.css?v=2026041603',
    './css/settings.css?v=2026041603',
    './js/app.js?v=2026041603',
    './js/timer.js?v=2026041603',
    './js/scramble.js?v=2026041603',
    './js/subset-scramblers.js?v=2026041603',
    './js/session.js?v=2026041603',
    './js/settings.js?v=2026041603',
    './js/stats.js?v=2026041603',
    './js/modal.js?v=2026041603',
    './js/cube-display.js?v=2026041603',
    './js/graph.js?v=2026041603',
    './js/utils.js?v=2026041603',
    './js/storage.js?v=2026041603',
    './js/db.js?v=2026041603',
    './js/distribution.js?v=2026041603',
    './js/google-drive-sync.js?v=2026041603',
