const APP_CACHE_NAME = 'ukratimer-app-v202604054';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604054';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604054',
    './css/fonts.css?v=202604054',
    './css/variables.css?v=202604054',
    './css/base.css?v=202604054',
    './css/layout.css?v=202604054',
    './css/scramble.css?v=202604054',
    './css/timer.css?v=202604054',
    './css/stats.css?v=202604054',
    './css/cube.css?v=202604054',
    './css/graph.css?v=202604054',
    './css/modal.css?v=202604054',
    './css/settings.css?v=202604054',
    './js/app.js?v=202604054',
    './js/timer.js?v=202604054',
    './js/scramble.js?v=202604054',
    './js/session.js?v=202604054',
    './js/settings.js?v=202604054',
    './js/stats.js?v=202604054',
    './js/modal.js?v=202604054',
    './js/cube-display.js?v=202604054',
    './js/graph.js?v=202604054',
    './js/utils.js?v=202604054',
    './js/storage.js?v=202604054',
    './js/db.js?v=202604054',
    './js/distribution.js?v=202604054',
    './js/google-drive-sync.js?v=202604054',
