const APP_CACHE_NAME = 'ukratimer-app-v2026041201';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041201';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041201',
    './css/fonts.css?v=2026041201',
    './css/variables.css?v=2026041201',
    './css/base.css?v=2026041201',
    './css/layout.css?v=2026041201',
    './css/scramble.css?v=2026041201',
    './css/timer.css?v=2026041201',
    './css/stats.css?v=2026041201',
    './css/cube.css?v=2026041201',
    './css/graph.css?v=2026041201',
    './css/modal.css?v=2026041201',
    './css/settings.css?v=2026041201',
    './js/app.js?v=2026041201',
    './js/timer.js?v=2026041201',
    './js/scramble.js?v=2026041201',
    './js/subset-scramblers.js?v=2026041201',
    './js/session.js?v=2026041201',
    './js/settings.js?v=2026041201',
    './js/stats.js?v=2026041201',
    './js/modal.js?v=2026041201',
    './js/cube-display.js?v=2026041201',
    './js/graph.js?v=2026041201',
    './js/utils.js?v=2026041201',
    './js/storage.js?v=2026041201',
    './js/db.js?v=2026041201',
    './js/distribution.js?v=2026041201',
    './js/google-drive-sync.js?v=2026041201',
