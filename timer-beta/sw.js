const APP_CACHE_NAME = 'ukratimer-app-v2026040573';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040573';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040573',
    './css/fonts.css?v=2026040573',
    './css/variables.css?v=2026040573',
    './css/base.css?v=2026040573',
    './css/layout.css?v=2026040573',
    './css/scramble.css?v=2026040573',
    './css/timer.css?v=2026040573',
    './css/stats.css?v=2026040573',
    './css/cube.css?v=2026040573',
    './css/graph.css?v=2026040573',
    './css/modal.css?v=2026040573',
    './css/settings.css?v=2026040573',
    './js/app.js?v=2026040573',
    './js/timer.js?v=2026040573',
    './js/scramble.js?v=2026040573',
    './js/session.js?v=2026040573',
    './js/settings.js?v=2026040573',
    './js/stats.js?v=2026040573',
    './js/modal.js?v=2026040573',
    './js/cube-display.js?v=2026040573',
    './js/graph.js?v=2026040573',
    './js/utils.js?v=2026040573',
    './js/storage.js?v=2026040573',
    './js/db.js?v=2026040573',
    './js/distribution.js?v=2026040573',
    './js/google-drive-sync.js?v=2026040573',
