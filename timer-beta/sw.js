const APP_CACHE_NAME = 'ukratimer-app-v2026041505';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041505';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041505',
    './css/fonts.css?v=2026041505',
    './css/variables.css?v=2026041505',
    './css/base.css?v=2026041505',
    './css/layout.css?v=2026041505',
    './css/scramble.css?v=2026041505',
    './css/timer.css?v=2026041505',
    './css/stats.css?v=2026041505',
    './css/cube.css?v=2026041505',
    './css/graph.css?v=2026041505',
    './css/modal.css?v=2026041505',
    './css/settings.css?v=2026041505',
    './js/app.js?v=2026041505',
    './js/timer.js?v=2026041505',
    './js/scramble.js?v=2026041505',
    './js/subset-scramblers.js?v=2026041505',
    './js/session.js?v=2026041505',
    './js/settings.js?v=2026041505',
    './js/stats.js?v=2026041505',
    './js/modal.js?v=2026041505',
    './js/cube-display.js?v=2026041505',
    './js/graph.js?v=2026041505',
    './js/utils.js?v=2026041505',
    './js/storage.js?v=2026041505',
    './js/db.js?v=2026041505',
    './js/distribution.js?v=2026041505',
    './js/google-drive-sync.js?v=2026041505',
