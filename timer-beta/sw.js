const APP_CACHE_NAME = 'ukratimer-app-v2026040903';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040903';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040903',
    './css/fonts.css?v=2026040903',
    './css/variables.css?v=2026040903',
    './css/base.css?v=2026040903',
    './css/layout.css?v=2026040903',
    './css/scramble.css?v=2026040903',
    './css/timer.css?v=2026040903',
    './css/stats.css?v=2026040903',
    './css/cube.css?v=2026040903',
    './css/graph.css?v=2026040903',
    './css/modal.css?v=2026040903',
    './css/settings.css?v=2026040903',
    './js/app.js?v=2026040903',
    './js/timer.js?v=2026040903',
    './js/scramble.js?v=2026040903',
    './js/subset-scramblers.js?v=2026040903',
    './js/session.js?v=2026040903',
    './js/settings.js?v=2026040903',
    './js/stats.js?v=2026040903',
    './js/modal.js?v=2026040903',
    './js/cube-display.js?v=2026040903',
    './js/graph.js?v=2026040903',
    './js/utils.js?v=2026040903',
    './js/storage.js?v=2026040903',
    './js/db.js?v=2026040903',
    './js/distribution.js?v=2026040903',
    './js/google-drive-sync.js?v=2026040903',
