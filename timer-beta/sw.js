const APP_CACHE_NAME = 'ukratimer-app-v2026040902';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040902';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040902',
    './css/fonts.css?v=2026040902',
    './css/variables.css?v=2026040902',
    './css/base.css?v=2026040902',
    './css/layout.css?v=2026040902',
    './css/scramble.css?v=2026040902',
    './css/timer.css?v=2026040902',
    './css/stats.css?v=2026040902',
    './css/cube.css?v=2026040902',
    './css/graph.css?v=2026040902',
    './css/modal.css?v=2026040902',
    './css/settings.css?v=2026040902',
    './js/app.js?v=2026040902',
    './js/timer.js?v=2026040902',
    './js/scramble.js?v=2026040902',
    './js/subset-scramblers.js?v=2026040902',
    './js/session.js?v=2026040902',
    './js/settings.js?v=2026040902',
    './js/stats.js?v=2026040902',
    './js/modal.js?v=2026040902',
    './js/cube-display.js?v=2026040902',
    './js/graph.js?v=2026040902',
    './js/utils.js?v=2026040902',
    './js/storage.js?v=2026040902',
    './js/db.js?v=2026040902',
    './js/distribution.js?v=2026040902',
    './js/google-drive-sync.js?v=2026040902',
