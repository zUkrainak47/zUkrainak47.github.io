const APP_CACHE_NAME = 'ukratimer-app-v2026042503';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042503';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042503',
    './css/fonts.css?v=2026042503',
    './css/variables.css?v=2026042503',
    './css/base.css?v=2026042503',
    './css/layout.css?v=2026042503',
    './css/scramble.css?v=2026042503',
    './css/timer.css?v=2026042503',
    './css/stats.css?v=2026042503',
    './css/cube.css?v=2026042503',
    './css/graph.css?v=2026042503',
    './css/modal.css?v=2026042503',
    './css/settings.css?v=2026042503',
    './js/app.js?v=2026042503',
    './js/timer.js?v=2026042503',
    './js/scramble.js?v=2026042503',
    './js/subset-scramblers.js?v=2026042503',
    './js/session.js?v=2026042503',
    './js/settings.js?v=2026042503',
    './js/stats.js?v=2026042503',
    './js/modal.js?v=2026042503',
    './js/time-entry.js?v=2026042503',
    './js/crypto-aes128.js?v=2026042503',
    './js/hardware-stackmat.js?v=2026042503',
    './js/hardware-bluetooth-timer.js?v=2026042503',
    './js/cube-display.js?v=2026042503',
    './js/graph.js?v=2026042503',
    './js/utils.js?v=2026042503',
    './js/storage.js?v=2026042503',
    './js/db.js?v=2026042503',
    './js/distribution.js?v=2026042503',
    './js/google-drive-sync.js?v=2026042503',
