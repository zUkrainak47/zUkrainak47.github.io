const APP_CACHE_NAME = 'ukratimer-app-v2026040904';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040904';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040904',
    './css/fonts.css?v=2026040904',
    './css/variables.css?v=2026040904',
    './css/base.css?v=2026040904',
    './css/layout.css?v=2026040904',
    './css/scramble.css?v=2026040904',
    './css/timer.css?v=2026040904',
    './css/stats.css?v=2026040904',
    './css/cube.css?v=2026040904',
    './css/graph.css?v=2026040904',
    './css/modal.css?v=2026040904',
    './css/settings.css?v=2026040904',
    './js/app.js?v=2026040904',
    './js/timer.js?v=2026040904',
    './js/scramble.js?v=2026040904',
    './js/subset-scramblers.js?v=2026040904',
    './js/session.js?v=2026040904',
    './js/settings.js?v=2026040904',
    './js/stats.js?v=2026040904',
    './js/modal.js?v=2026040904',
    './js/cube-display.js?v=2026040904',
    './js/graph.js?v=2026040904',
    './js/utils.js?v=2026040904',
    './js/storage.js?v=2026040904',
    './js/db.js?v=2026040904',
    './js/distribution.js?v=2026040904',
    './js/google-drive-sync.js?v=2026040904',
