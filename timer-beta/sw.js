const APP_CACHE_NAME = 'ukratimer-app-v2026042302';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042302';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042302',
    './css/fonts.css?v=2026042302',
    './css/variables.css?v=2026042302',
    './css/base.css?v=2026042302',
    './css/layout.css?v=2026042302',
    './css/scramble.css?v=2026042302',
    './css/timer.css?v=2026042302',
    './css/stats.css?v=2026042302',
    './css/cube.css?v=2026042302',
    './css/graph.css?v=2026042302',
    './css/modal.css?v=2026042302',
    './css/settings.css?v=2026042302',
    './js/app.js?v=2026042302',
    './js/timer.js?v=2026042302',
    './js/scramble.js?v=2026042302',
    './js/subset-scramblers.js?v=2026042302',
    './js/session.js?v=2026042302',
    './js/settings.js?v=2026042302',
    './js/stats.js?v=2026042302',
    './js/modal.js?v=2026042302',
    './js/time-entry.js?v=2026042302',
    './js/crypto-aes128.js?v=2026042302',
    './js/hardware-stackmat.js?v=2026042302',
    './js/hardware-bluetooth-timer.js?v=2026042302',
    './js/cube-display.js?v=2026042302',
    './js/graph.js?v=2026042302',
    './js/utils.js?v=2026042302',
    './js/storage.js?v=2026042302',
    './js/db.js?v=2026042302',
    './js/distribution.js?v=2026042302',
    './js/google-drive-sync.js?v=2026042302',
