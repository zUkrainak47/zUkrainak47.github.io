const APP_CACHE_NAME = 'ukratimer-app-v202604051';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604051';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604051',
    './css/fonts.css?v=202604051',
    './css/variables.css?v=202604051',
    './css/base.css?v=202604051',
    './css/layout.css?v=202604051',
    './css/scramble.css?v=202604051',
    './css/timer.css?v=202604051',
    './css/stats.css?v=202604051',
    './css/cube.css?v=202604051',
    './css/graph.css?v=202604051',
    './css/modal.css?v=202604051',
    './css/settings.css?v=202604051',
    './js/app.js?v=202604051',
    './js/timer.js?v=202604051',
    './js/scramble.js?v=202604051',
    './js/session.js?v=202604051',
    './js/settings.js?v=202604051',
    './js/stats.js?v=202604051',
    './js/modal.js?v=202604051',
    './js/cube-display.js?v=202604051',
    './js/graph.js?v=202604051',
    './js/utils.js?v=202604051',
    './js/storage.js?v=202604051',
    './js/db.js?v=202604051',
    './js/distribution.js?v=202604051',
    './js/google-drive-sync.js?v=202604051',
