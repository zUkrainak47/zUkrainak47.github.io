const APP_CACHE_NAME = 'ukratimer-app-v2026040901';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040901';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040901',
    './css/fonts.css?v=2026040901',
    './css/variables.css?v=2026040901',
    './css/base.css?v=2026040901',
    './css/layout.css?v=2026040901',
    './css/scramble.css?v=2026040901',
    './css/timer.css?v=2026040901',
    './css/stats.css?v=2026040901',
    './css/cube.css?v=2026040901',
    './css/graph.css?v=2026040901',
    './css/modal.css?v=2026040901',
    './css/settings.css?v=2026040901',
    './js/app.js?v=2026040901',
    './js/timer.js?v=2026040901',
    './js/scramble.js?v=2026040901',
    './js/subset-scramblers.js?v=2026040901',
    './js/session.js?v=2026040901',
    './js/settings.js?v=2026040901',
    './js/stats.js?v=2026040901',
    './js/modal.js?v=2026040901',
    './js/cube-display.js?v=2026040901',
    './js/graph.js?v=2026040901',
    './js/utils.js?v=2026040901',
    './js/storage.js?v=2026040901',
    './js/db.js?v=2026040901',
    './js/distribution.js?v=2026040901',
    './js/google-drive-sync.js?v=2026040901',
