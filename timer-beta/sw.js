const APP_CACHE_NAME = 'ukratimer-app-v2026040567';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040567';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040567',
    './css/fonts.css?v=2026040567',
    './css/variables.css?v=2026040567',
    './css/base.css?v=2026040567',
    './css/layout.css?v=2026040567',
    './css/scramble.css?v=2026040567',
    './css/timer.css?v=2026040567',
    './css/stats.css?v=2026040567',
    './css/cube.css?v=2026040567',
    './css/graph.css?v=2026040567',
    './css/modal.css?v=2026040567',
    './css/settings.css?v=2026040567',
    './js/app.js?v=2026040567',
    './js/timer.js?v=2026040567',
    './js/scramble.js?v=2026040567',
    './js/session.js?v=2026040567',
    './js/settings.js?v=2026040567',
    './js/stats.js?v=2026040567',
    './js/modal.js?v=2026040567',
    './js/cube-display.js?v=2026040567',
    './js/graph.js?v=2026040567',
    './js/utils.js?v=2026040567',
    './js/storage.js?v=2026040567',
    './js/db.js?v=2026040567',
    './js/distribution.js?v=2026040567',
    './js/google-drive-sync.js?v=2026040567',
