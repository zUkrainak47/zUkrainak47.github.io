const APP_CACHE_NAME = 'ukratimer-app-v2026040702';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040702';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040702',
    './css/fonts.css?v=2026040702',
    './css/variables.css?v=2026040702',
    './css/base.css?v=2026040702',
    './css/layout.css?v=2026040702',
    './css/scramble.css?v=2026040702',
    './css/timer.css?v=2026040702',
    './css/stats.css?v=2026040702',
    './css/cube.css?v=2026040702',
    './css/graph.css?v=2026040702',
    './css/modal.css?v=2026040702',
    './css/settings.css?v=2026040702',
    './js/app.js?v=2026040702',
    './js/timer.js?v=2026040702',
    './js/scramble.js?v=2026040702',
    './js/subset-scramblers.js?v=2026040702',
    './js/session.js?v=2026040702',
    './js/settings.js?v=2026040702',
    './js/stats.js?v=2026040702',
    './js/modal.js?v=2026040702',
    './js/cube-display.js?v=2026040702',
    './js/graph.js?v=2026040702',
    './js/utils.js?v=2026040702',
    './js/storage.js?v=2026040702',
    './js/db.js?v=2026040702',
    './js/distribution.js?v=2026040702',
    './js/google-drive-sync.js?v=2026040702',
