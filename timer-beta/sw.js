const APP_CACHE_NAME = 'ukratimer-app-v2026041401';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041401';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041401',
    './css/fonts.css?v=2026041401',
    './css/variables.css?v=2026041401',
    './css/base.css?v=2026041401',
    './css/layout.css?v=2026041401',
    './css/scramble.css?v=2026041401',
    './css/timer.css?v=2026041401',
    './css/stats.css?v=2026041401',
    './css/cube.css?v=2026041401',
    './css/graph.css?v=2026041401',
    './css/modal.css?v=2026041401',
    './css/settings.css?v=2026041401',
    './js/app.js?v=2026041401',
    './js/timer.js?v=2026041401',
    './js/scramble.js?v=2026041401',
    './js/subset-scramblers.js?v=2026041401',
    './js/session.js?v=2026041401',
    './js/settings.js?v=2026041401',
    './js/stats.js?v=2026041401',
    './js/modal.js?v=2026041401',
    './js/cube-display.js?v=2026041401',
    './js/graph.js?v=2026041401',
    './js/utils.js?v=2026041401',
    './js/storage.js?v=2026041401',
    './js/db.js?v=2026041401',
    './js/distribution.js?v=2026041401',
    './js/google-drive-sync.js?v=2026041401',
