const APP_CACHE_NAME = 'ukratimer-app-v2026041502';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041502';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041502',
    './css/fonts.css?v=2026041502',
    './css/variables.css?v=2026041502',
    './css/base.css?v=2026041502',
    './css/layout.css?v=2026041502',
    './css/scramble.css?v=2026041502',
    './css/timer.css?v=2026041502',
    './css/stats.css?v=2026041502',
    './css/cube.css?v=2026041502',
    './css/graph.css?v=2026041502',
    './css/modal.css?v=2026041502',
    './css/settings.css?v=2026041502',
    './js/app.js?v=2026041502',
    './js/timer.js?v=2026041502',
    './js/scramble.js?v=2026041502',
    './js/subset-scramblers.js?v=2026041502',
    './js/session.js?v=2026041502',
    './js/settings.js?v=2026041502',
    './js/stats.js?v=2026041502',
    './js/modal.js?v=2026041502',
    './js/cube-display.js?v=2026041502',
    './js/graph.js?v=2026041502',
    './js/utils.js?v=2026041502',
    './js/storage.js?v=2026041502',
    './js/db.js?v=2026041502',
    './js/distribution.js?v=2026041502',
    './js/google-drive-sync.js?v=2026041502',
