const APP_CACHE_NAME = 'ukratimer-app-v202604049';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604049';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604049',
    './css/fonts.css?v=202604049',
    './css/variables.css?v=202604049',
    './css/base.css?v=202604049',
    './css/layout.css?v=202604049',
    './css/scramble.css?v=202604049',
    './css/timer.css?v=202604049',
    './css/stats.css?v=202604049',
    './css/cube.css?v=202604049',
    './css/graph.css?v=202604049',
    './css/modal.css?v=202604049',
    './css/settings.css?v=202604049',
    './js/app.js?v=202604049',
    './js/timer.js?v=202604049',
    './js/scramble.js?v=202604049',
    './js/session.js?v=202604049',
    './js/settings.js?v=202604049',
    './js/stats.js?v=202604049',
    './js/modal.js?v=202604049',
    './js/cube-display.js?v=202604049',
    './js/graph.js?v=202604049',
    './js/utils.js?v=202604049',
    './js/storage.js?v=202604049',
    './js/db.js?v=202604049',
    './js/distribution.js?v=202604049',
    './js/google-drive-sync.js?v=202604049',
