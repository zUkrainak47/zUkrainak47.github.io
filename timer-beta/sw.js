const APP_CACHE_NAME = 'ukratimer-app-v2026040570';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040570';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040570',
    './css/fonts.css?v=2026040570',
    './css/variables.css?v=2026040570',
    './css/base.css?v=2026040570',
    './css/layout.css?v=2026040570',
    './css/scramble.css?v=2026040570',
    './css/timer.css?v=2026040570',
    './css/stats.css?v=2026040570',
    './css/cube.css?v=2026040570',
    './css/graph.css?v=2026040570',
    './css/modal.css?v=2026040570',
    './css/settings.css?v=2026040570',
    './js/app.js?v=2026040570',
    './js/timer.js?v=2026040570',
    './js/scramble.js?v=2026040570',
    './js/session.js?v=2026040570',
    './js/settings.js?v=2026040570',
    './js/stats.js?v=2026040570',
    './js/modal.js?v=2026040570',
    './js/cube-display.js?v=2026040570',
    './js/graph.js?v=2026040570',
    './js/utils.js?v=2026040570',
    './js/storage.js?v=2026040570',
    './js/db.js?v=2026040570',
    './js/distribution.js?v=2026040570',
    './js/google-drive-sync.js?v=2026040570',
