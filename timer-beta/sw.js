const APP_CACHE_NAME = 'ukratimer-app-v2026041607';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041607';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041607',
    './css/fonts.css?v=2026041607',
    './css/variables.css?v=2026041607',
    './css/base.css?v=2026041607',
    './css/layout.css?v=2026041607',
    './css/scramble.css?v=2026041607',
    './css/timer.css?v=2026041607',
    './css/stats.css?v=2026041607',
    './css/cube.css?v=2026041607',
    './css/graph.css?v=2026041607',
    './css/modal.css?v=2026041607',
    './css/settings.css?v=2026041607',
    './js/app.js?v=2026041607',
    './js/timer.js?v=2026041607',
    './js/scramble.js?v=2026041607',
    './js/subset-scramblers.js?v=2026041607',
    './js/session.js?v=2026041607',
    './js/settings.js?v=2026041607',
    './js/stats.js?v=2026041607',
    './js/modal.js?v=2026041607',
    './js/cube-display.js?v=2026041607',
    './js/graph.js?v=2026041607',
    './js/utils.js?v=2026041607',
    './js/storage.js?v=2026041607',
    './js/db.js?v=2026041607',
    './js/distribution.js?v=2026041607',
    './js/google-drive-sync.js?v=2026041607',
