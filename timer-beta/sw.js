const APP_CACHE_NAME = 'ukratimer-app-v202604053';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604053';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604053',
    './css/fonts.css?v=202604053',
    './css/variables.css?v=202604053',
    './css/base.css?v=202604053',
    './css/layout.css?v=202604053',
    './css/scramble.css?v=202604053',
    './css/timer.css?v=202604053',
    './css/stats.css?v=202604053',
    './css/cube.css?v=202604053',
    './css/graph.css?v=202604053',
    './css/modal.css?v=202604053',
    './css/settings.css?v=202604053',
    './js/app.js?v=202604053',
    './js/timer.js?v=202604053',
    './js/scramble.js?v=202604053',
    './js/session.js?v=202604053',
    './js/settings.js?v=202604053',
    './js/stats.js?v=202604053',
    './js/modal.js?v=202604053',
    './js/cube-display.js?v=202604053',
    './js/graph.js?v=202604053',
    './js/utils.js?v=202604053',
    './js/storage.js?v=202604053',
    './js/db.js?v=202604053',
    './js/distribution.js?v=202604053',
    './js/google-drive-sync.js?v=202604053',
