const APP_CACHE_NAME = 'ukratimer-app-v2026041501';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041501';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041501',
    './css/fonts.css?v=2026041501',
    './css/variables.css?v=2026041501',
    './css/base.css?v=2026041501',
    './css/layout.css?v=2026041501',
    './css/scramble.css?v=2026041501',
    './css/timer.css?v=2026041501',
    './css/stats.css?v=2026041501',
    './css/cube.css?v=2026041501',
    './css/graph.css?v=2026041501',
    './css/modal.css?v=2026041501',
    './css/settings.css?v=2026041501',
    './js/app.js?v=2026041501',
    './js/timer.js?v=2026041501',
    './js/scramble.js?v=2026041501',
    './js/subset-scramblers.js?v=2026041501',
    './js/session.js?v=2026041501',
    './js/settings.js?v=2026041501',
    './js/stats.js?v=2026041501',
    './js/modal.js?v=2026041501',
    './js/cube-display.js?v=2026041501',
    './js/graph.js?v=2026041501',
    './js/utils.js?v=2026041501',
    './js/storage.js?v=2026041501',
    './js/db.js?v=2026041501',
    './js/distribution.js?v=2026041501',
    './js/google-drive-sync.js?v=2026041501',
