const APP_CACHE_NAME = 'ukratimer-app-v202604048';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604048';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604048',
    './css/fonts.css?v=202604048',
    './css/variables.css?v=202604048',
    './css/base.css?v=202604048',
    './css/layout.css?v=202604048',
    './css/scramble.css?v=202604048',
    './css/timer.css?v=202604048',
    './css/stats.css?v=202604048',
    './css/cube.css?v=202604048',
    './css/graph.css?v=202604048',
    './css/modal.css?v=202604048',
    './css/settings.css?v=202604048',
    './js/app.js?v=202604048',
    './js/timer.js?v=202604048',
    './js/scramble.js?v=202604048',
    './js/session.js?v=202604048',
    './js/settings.js?v=202604048',
    './js/stats.js?v=202604048',
    './js/modal.js?v=202604048',
    './js/cube-display.js?v=202604048',
    './js/graph.js?v=202604048',
    './js/utils.js?v=202604048',
    './js/storage.js?v=202604048',
    './js/db.js?v=202604048',
    './js/distribution.js?v=202604048',
    './js/google-drive-sync.js?v=202604048',
