const APP_CACHE_NAME = 'ukratimer-app-v202604052';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604052';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604052',
    './css/fonts.css?v=202604052',
    './css/variables.css?v=202604052',
    './css/base.css?v=202604052',
    './css/layout.css?v=202604052',
    './css/scramble.css?v=202604052',
    './css/timer.css?v=202604052',
    './css/stats.css?v=202604052',
    './css/cube.css?v=202604052',
    './css/graph.css?v=202604052',
    './css/modal.css?v=202604052',
    './css/settings.css?v=202604052',
    './js/app.js?v=202604052',
    './js/timer.js?v=202604052',
    './js/scramble.js?v=202604052',
    './js/session.js?v=202604052',
    './js/settings.js?v=202604052',
    './js/stats.js?v=202604052',
    './js/modal.js?v=202604052',
    './js/cube-display.js?v=202604052',
    './js/graph.js?v=202604052',
    './js/utils.js?v=202604052',
    './js/storage.js?v=202604052',
    './js/db.js?v=202604052',
    './js/distribution.js?v=202604052',
    './js/google-drive-sync.js?v=202604052',
