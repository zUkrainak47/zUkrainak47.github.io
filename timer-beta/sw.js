const APP_CACHE_NAME = 'ukratimer-app-v202604055';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v202604055';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=202604055',
    './css/fonts.css?v=202604055',
    './css/variables.css?v=202604055',
    './css/base.css?v=202604055',
    './css/layout.css?v=202604055',
    './css/scramble.css?v=202604055',
    './css/timer.css?v=202604055',
    './css/stats.css?v=202604055',
    './css/cube.css?v=202604055',
    './css/graph.css?v=202604055',
    './css/modal.css?v=202604055',
    './css/settings.css?v=202604055',
    './js/app.js?v=202604055',
    './js/timer.js?v=202604055',
    './js/scramble.js?v=202604055',
    './js/session.js?v=202604055',
    './js/settings.js?v=202604055',
    './js/stats.js?v=202604055',
    './js/modal.js?v=202604055',
    './js/cube-display.js?v=202604055',
    './js/graph.js?v=202604055',
    './js/utils.js?v=202604055',
    './js/storage.js?v=202604055',
    './js/db.js?v=202604055',
    './js/distribution.js?v=202604055',
    './js/google-drive-sync.js?v=202604055',
