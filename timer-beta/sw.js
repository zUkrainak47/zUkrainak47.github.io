const APP_CACHE_NAME = 'ukratimer-app-v2026041504';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041504';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041504',
    './css/fonts.css?v=2026041504',
    './css/variables.css?v=2026041504',
    './css/base.css?v=2026041504',
    './css/layout.css?v=2026041504',
    './css/scramble.css?v=2026041504',
    './css/timer.css?v=2026041504',
    './css/stats.css?v=2026041504',
    './css/cube.css?v=2026041504',
    './css/graph.css?v=2026041504',
    './css/modal.css?v=2026041504',
    './css/settings.css?v=2026041504',
    './js/app.js?v=2026041504',
    './js/timer.js?v=2026041504',
    './js/scramble.js?v=2026041504',
    './js/subset-scramblers.js?v=2026041504',
    './js/session.js?v=2026041504',
    './js/settings.js?v=2026041504',
    './js/stats.js?v=2026041504',
    './js/modal.js?v=2026041504',
    './js/cube-display.js?v=2026041504',
    './js/graph.js?v=2026041504',
    './js/utils.js?v=2026041504',
    './js/storage.js?v=2026041504',
    './js/db.js?v=2026041504',
    './js/distribution.js?v=2026041504',
    './js/google-drive-sync.js?v=2026041504',
