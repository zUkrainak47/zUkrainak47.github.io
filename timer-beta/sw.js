const APP_CACHE_NAME = 'ukratimer-app-v2026040575';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026040575';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026040575',
    './css/fonts.css?v=2026040575',
    './css/variables.css?v=2026040575',
    './css/base.css?v=2026040575',
    './css/layout.css?v=2026040575',
    './css/scramble.css?v=2026040575',
    './css/timer.css?v=2026040575',
    './css/stats.css?v=2026040575',
    './css/cube.css?v=2026040575',
    './css/graph.css?v=2026040575',
    './css/modal.css?v=2026040575',
    './css/settings.css?v=2026040575',
    './js/app.js?v=2026040575',
    './js/timer.js?v=2026040575',
    './js/scramble.js?v=2026040575',
    './js/session.js?v=2026040575',
    './js/settings.js?v=2026040575',
    './js/stats.js?v=2026040575',
    './js/modal.js?v=2026040575',
    './js/cube-display.js?v=2026040575',
    './js/graph.js?v=2026040575',
    './js/utils.js?v=2026040575',
    './js/storage.js?v=2026040575',
    './js/db.js?v=2026040575',
    './js/distribution.js?v=2026040575',
    './js/google-drive-sync.js?v=2026040575',
