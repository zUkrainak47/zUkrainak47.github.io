...
export const THEME_COLOR_SECTIONS = Object.freeze([
    ...
    Object.freeze({
        ...
        title: 'Graph',
        items: Object.freeze([
            Object.freeze({ key: 'statBest', variable: '--stat-best', label: 'Best stat' }),
            Object.freeze({ key: 'statWorst', variable: '--stat-worst', label: 'Worst stat' }),
            Object.freeze({ key: 'statAo5', variable: '--stat-ao5', label: 'ao5 stat' }),
            Object.freeze({ key: 'statAo12', variable: '--stat-ao12', label: 'ao12 stat' }),
            Object.freeze({ key: 'statAo100', variable: '--stat-ao100', label: 'ao100 stat' }),
