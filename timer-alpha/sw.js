const APP_CACHE_NAME = 'ukratimer-app-v2026041802';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026041802';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026041802',
    './css/fonts.css?v=2026041802',
    './css/variables.css?v=2026041802',
    './css/base.css?v=2026041802',
    './css/layout.css?v=2026041802',
    './css/scramble.css?v=2026041802',
    './css/timer.css?v=2026041802',
    './css/stats.css?v=2026041802',
    './css/cube.css?v=2026041802',
    './css/graph.css?v=2026041802',
    './css/modal.css?v=2026041802',
    './css/settings.css?v=2026041802',
    './js/app.js?v=2026041802',
    './js/timer.js?v=2026041802',
    './js/scramble.js?v=2026041802',
    './js/subset-scramblers.js?v=2026041802',
    './js/session.js?v=2026041802',
    './js/settings.js?v=2026041802',
    './js/stats.js?v=2026041802',
    './js/modal.js?v=2026041802',
    './js/time-entry.js?v=2026041802',
    './js/crypto-aes128.js?v=2026041802',
    './js/hardware-stackmat.js?v=2026041802',
    './js/hardware-bluetooth-timer.js?v=2026041802',
    './js/cube-display.js?v=2026041802',
    './js/graph.js?v=2026041802',
    './js/utils.js?v=2026041802',
    './js/storage.js?v=2026041802',
    './js/db.js?v=2026041802',
    './js/distribution.js?v=2026041802',
    './js/google-drive-sync.js?v=2026041802',
