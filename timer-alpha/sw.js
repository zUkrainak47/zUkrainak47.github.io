const APP_CACHE_NAME = 'ukratimer-app-v2026042301';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042301';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042301',
    './css/fonts.css?v=2026042301',
    './css/variables.css?v=2026042301',
    './css/base.css?v=2026042301',
    './css/layout.css?v=2026042301',
    './css/scramble.css?v=2026042301',
    './css/timer.css?v=2026042301',
    './css/stats.css?v=2026042301',
    './css/cube.css?v=2026042301',
    './css/graph.css?v=2026042301',
    './css/modal.css?v=2026042301',
    './css/settings.css?v=2026042301',
    './js/app.js?v=2026042301',
    './js/timer.js?v=2026042301',
    './js/scramble.js?v=2026042301',
    './js/subset-scramblers.js?v=2026042301',
    './js/session.js?v=2026042301',
    './js/settings.js?v=2026042301',
    './js/stats.js?v=2026042301',
    './js/modal.js?v=2026042301',
    './js/time-entry.js?v=2026042301',
    './js/crypto-aes128.js?v=2026042301',
    './js/hardware-stackmat.js?v=2026042301',
    './js/hardware-bluetooth-timer.js?v=2026042301',
    './js/cube-display.js?v=2026042301',
    './js/graph.js?v=2026042301',
    './js/utils.js?v=2026042301',
    './js/storage.js?v=2026042301',
    './js/db.js?v=2026042301',
    './js/distribution.js?v=2026042301',
    './js/google-drive-sync.js?v=2026042301',
