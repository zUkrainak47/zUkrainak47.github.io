const APP_CACHE_NAME = 'ukratimer-app-v2026042506';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042506';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042506',
    './css/fonts.css?v=2026042506',
    './css/variables.css?v=2026042506',
    './css/base.css?v=2026042506',
    './css/layout.css?v=2026042506',
    './css/scramble.css?v=2026042506',
    './css/timer.css?v=2026042506',
    './css/stats.css?v=2026042506',
    './css/cube.css?v=2026042506',
    './css/graph.css?v=2026042506',
    './css/modal.css?v=2026042506',
    './css/settings.css?v=2026042506',
    './js/app.js?v=2026042506',
    './js/timer.js?v=2026042506',
    './js/scramble.js?v=2026042506',
    './js/subset-scramblers.js?v=2026042506',
    './js/session.js?v=2026042506',
    './js/settings.js?v=2026042506',
    './js/stats.js?v=2026042506',
    './js/modal.js?v=2026042506',
    './js/time-entry.js?v=2026042506',
    './js/crypto-aes128.js?v=2026042506',
    './js/hardware-stackmat.js?v=2026042506',
    './js/hardware-bluetooth-timer.js?v=2026042506',
    './js/cube-display.js?v=2026042506',
    './js/graph.js?v=2026042506',
    './js/utils.js?v=2026042506',
    './js/storage.js?v=2026042506',
    './js/db.js?v=2026042506',
    './js/distribution.js?v=2026042506',
    './js/google-drive-sync.js?v=2026042506',
