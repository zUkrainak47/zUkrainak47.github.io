const APP_CACHE_NAME = 'ukratimer-app-v2026042505';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042505';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042505',
    './css/fonts.css?v=2026042505',
    './css/variables.css?v=2026042505',
    './css/base.css?v=2026042505',
    './css/layout.css?v=2026042505',
    './css/scramble.css?v=2026042505',
    './css/timer.css?v=2026042505',
    './css/stats.css?v=2026042505',
    './css/cube.css?v=2026042505',
    './css/graph.css?v=2026042505',
    './css/modal.css?v=2026042505',
    './css/settings.css?v=2026042505',
    './js/app.js?v=2026042505',
    './js/timer.js?v=2026042505',
    './js/scramble.js?v=2026042505',
    './js/subset-scramblers.js?v=2026042505',
    './js/session.js?v=2026042505',
    './js/settings.js?v=2026042505',
    './js/stats.js?v=2026042505',
    './js/modal.js?v=2026042505',
    './js/time-entry.js?v=2026042505',
    './js/crypto-aes128.js?v=2026042505',
    './js/hardware-stackmat.js?v=2026042505',
    './js/hardware-bluetooth-timer.js?v=2026042505',
    './js/cube-display.js?v=2026042505',
    './js/graph.js?v=2026042505',
    './js/utils.js?v=2026042505',
    './js/storage.js?v=2026042505',
    './js/db.js?v=2026042505',
    './js/distribution.js?v=2026042505',
    './js/google-drive-sync.js?v=2026042505',
