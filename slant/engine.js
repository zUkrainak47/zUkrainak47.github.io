...
(() => {
  ...
  const HOTKEY_ACTIONS = [
    ...
    { id: "line", label: "Line" },
    { id: "hidePanels", label: "Hide all panels" },
  ];
  const DEFAULT_HOTKEYS = { select: "v", diagonal: "d", diagFwd: "q", diagBwd: "e", flipDiag: "f", number: "n", arrow: "a", highlight: "h", line: "l", hidePanels: "z" };
  ...
  function updateToolTitles() {
    ...
    const togglePanelsHotkey = hotkeys["hidePanels"];
    const btnTogglePanels = $("btn-toggle-panels");
    if (btnTogglePanels) {
      const hkUpper = togglePanelsHotkey ? togglePanelsHotkey.toUpperCase() : "—";
      btnTogglePanels.title = `${panelsHidden ? "Show" : "Hide"} all panels (${hkUpper})`;
    }
    const floatingBtn = $("btn-floating-panels-toggle");
    if (floatingBtn) {
      const hkUpper = togglePanelsHotkey ? togglePanelsHotkey.toUpperCase() : "—";
      floatingBtn.title = `Show panels (${hkUpper})`;
    }
  }
  ...
  function togglePanels() {
    ...
    const btnToggle = $("btn-toggle-panels");
    if (btnToggle) {
      btnToggle.classList.toggle("active", panelsHidden);
    }
    updateToolTitles();
    requestDraw();
  }

  $("btn-toggle-panels").addEventListener("click", togglePanels);
  $("btn-floating-panels-toggle").addEventListener("click", togglePanels);
